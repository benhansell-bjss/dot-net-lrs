        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Choices = table.Column<string>(type: "varchar", nullable: true),
                    Scale = table.Column<string>(type: "varchar", nullable: true),
                    Source = table.Column<string>(type: "varchar", nullable: true),
                    Target = table.Column<string>(type: "varchar", nullable: true),
                    Steps = table.Column<string>(type: "varchar", nullable: true),
                    SequencingInteractionActivity_Choices = table.Column<string>(type: "varchar", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Extensions = table.Column<string>(type: "varchar", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StatementRefs", x => x.StatementRefId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Display = table.Column<string>(type: "varchar", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContextActivities_Category_ContextActivities_ContextActivit~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContextActivities_Grouping_ContextActivities_ContextActivit~",
                        column: x => x.ContextActivitiesEntityContextActivitiesId,
                        principalTable: "ContextActivities",
                        principalColumn: "ContextActivitiesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContextActivities_Other_ContextActivities_ContextActivities~",
                        column: x => x.ContextActivitiesEntityContextActivitiesId,
                        principalTable: "ContextActivities",
                        principalColumn: "ContextActivitiesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContextActivities_Parent_ContextActivities_ContextActivitie~",
                        column: x => x.ContextActivitiesEntityContextActivitiesId,
                        principalTable: "ContextActivities",
                        principalColumn: "ContextActivitiesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Names = table.Column<string>(type: "varchar", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityDefinitions_InteractionActivities_InteractionActivi~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_ActivityDefinitions_DefinitionActivityDefinition~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Display = table.Column<string>(type: "varchar", nullable: false),
